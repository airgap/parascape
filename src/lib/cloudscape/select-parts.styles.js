// Vendored class map for @cloudscape-design/components/select/parts/styles.css.js
// (the select/multiselect dropdown "parts": inline label, placeholder, and the
// non-sticky list-bottom footer slot). Hashes mirror the installed build's
// select/parts/styles.selectors.js so the conformance finders resolve.
export default {
