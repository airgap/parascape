// VENDORED from @cloudscape-design/components/space-between/styles.css.js
// (package does not export this subpath). Logical->hashed CSS-module
// class map; pairs with space-between.scoped.css.
export default {
