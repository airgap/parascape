...
lines.push(
  `**${ported.length} / ${total}** Cloudscape components ported to \`.pui\` at ` +
    ...
    `(shared core \`shoot-lib.mjs\`): \`box-shoot.mjs\` (520px matrix), ` +
    `\`wide-shoot.mjs\` (1280px column — trips the container-query ` +
    `breakpoints the narrow matrix can't: Wizard desktop, Cards multi-column, ` +
    `AttributeEditor wide grid), \`cp-shoot.mjs\` / \`popover-shoot.mjs\` ` +
    `(open-state overlay dialogs), \`shoot.mjs\` (Table).`,
);
lines.push("");
