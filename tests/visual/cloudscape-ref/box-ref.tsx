...
function M() {
  return (
    ...
    >
      ...
      <div>
        <ButtonDropdown variant="primary" items={[{ id: "a", text: "One" }]} onItemClick={noop}>
          Primary
        </ButtonDropdown>
      </div>
      <div>
        <ButtonDropdown variant="icon" ariaLabel="More" items={[{ id: "a", text: "X" }]} onItemClick={noop} />
      </div>
      <div>
        <KeyValuePairs
          ariaLabel="Demo KVP"
      ...
      <div>
        <Calendar value="2026-05-18" locale="en-US" onChange={noop} />
      </div>
      <div>
        <ButtonGroup
          ariaLabel="Actions"
