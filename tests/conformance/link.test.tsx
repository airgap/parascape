...
const { FunnelMetrics } = __STUB; // stub: ../../../lib/components/internal/analytics
const { AnalyticsFunnel } = __STUB; // stub: ../../../lib/components/internal/analytics/components/analytics-funnel
...
describe('native attributes', () => {
  ...
  it('concatenates class names', () => {
    ...
    expect(container.firstElementChild).toHaveClass(styles.link);
