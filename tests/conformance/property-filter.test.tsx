// AUTO-ADAPTED from cloudscape-design/components src/property-filter/__tests__/
// property-filter.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, jest.mock → hoisted vi.mock; stubbed unresolvable ../../../lib/components/property-filter/interfaces; interaction (manual-triage tier).
...
const { FilteringOption,
  FilteringProperty,
  PropertyFilterProps, } = __STUB; // stub: ../../../lib/components/property-filter/interfaces
import { createWrapper, ElementWrapper, PropertyFilterWrapper } from '@conformance/adapter';
import { createDefaultProps } from '@conformance/property-filter.common';
