...
// render → adapter, styles → vendored, stubbed unresolvable ../../../lib/components/internal/debounce; interaction (manual-triage tier).
...
const { DEBOUNCE_DEFAULT_DELAY } = __STUB; // stub: ../../../lib/components/internal/debounce
