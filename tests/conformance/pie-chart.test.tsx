...
import PieChart from '@components/PieChart.pui';
...
const sizes: Array<any['size']> = ['small', 'medium', 'large'];
const statusTypes: Array<any['statusType']> = ['finished', 'loading', 'error'];
...
const defaultData: Array<any.Datum> = [
  {
    title: 'Segment 1',
    value: 20,
  },
...
const defaultSegmentDescription: any.SegmentDescriptionFunction = datum =>
  datum.title === 'Segment 2' ? 'Segment description' : '';

const dataWithZero: Array<any.Datum> = [
