...
import AttributeEditor from '@components/AttributeEditor.pui';
...
function renderAttributeEditor(
  props: Partial<any> & { ref?: React.Ref<any.Ref> } = {}
...
function TestComponent(propOverrides: Partial<any> = {}) {
...
describe('Attribute Editor', () => {
  ...
  describe('add button', () => {
    ...
    test('allows the add button to be focused manually when disableAddButton is true', () => {
      const ref: React.Ref<any.Ref> = React.createRef();
  ...
  describe('ref', () => {
    let ref: any.Ref, wrapper: AttributeEditorWrapper;
    beforeEach(() => {
      wrapper = renderAttributeEditor({
        ...defaultProps,
        ref: newRef => {
