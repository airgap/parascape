// AUTO-ADAPTED from cloudscape-design/components src/breadcrumb-group/__tests__/
// breadcrumb-group.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, i18n/testing → passthrough provider; jest.mock → hoisted vi.mock; stubbed unresolvable ../../../lib/components/internal/analytics/selectors; interaction (manual-triage tier).
...
import BreadcrumbGroup from '@components/BreadcrumbGroup.pui';
const TestI18nProvider = (({ children }: any) => children) as any;
const { DATA_ATTR_RESOURCE_TYPE, getFunnelNameSelector } = __STUB; // stub: ../../../lib/components/internal/analytics/selectors
import { createWrapper, BreadcrumbGroupWrapper, ElementWrapper } from '@conformance/adapter';

import itemStyles from '@cloudscape/breadcrumb-group-item.styles.js';
import styles from '@cloudscape/breadcrumb-group.styles.js';
...
const renderBreadcrumbGroup = (props: any) => {
...
describe('BreadcrumbGroup Component', () => {
  ...
  test.each([[true], [false]])('supports extended items object (mobile: %p)', mobile => {
    ...
    interface ExtendedItem extends any.Item {
      metadata: number;
    }
