// AUTO-ADAPTED from cloudscape-design/components src/pagination/__tests__/
// pagination.test.tsx via tests/conformance/codemod.mjs.
...
import Pagination from '@components/Pagination.pui';
import { createWrapper, PaginationWrapper } from '@conformance/adapter';
