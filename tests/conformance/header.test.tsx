// AUTO-ADAPTED from cloudscape-design/components src/header/__tests__/
// header.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, stubbed unresolvable ../../../lib/components/internal/analytics/selectors.
...
const { DATA_ATTR_FUNNEL_KEY, FUNNEL_KEY_SUBSTEP_NAME } = __STUB; // stub: ../../../lib/components/internal/analytics/selectors
