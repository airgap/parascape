...
describe('Box', () => {
  ...
  ['margin', 'padding'].forEach(spacingType => {
    describe(`${spacingType} property`, () => {
      const sizes = ['n', 'xxxs', 'xxs', 'xs', 's', 'm', 'l', 'xl', 'xxl', 'xxxl'] as Array<any.SpacingSize>;
  ...
  testClassNamesForProperty<any.Display>('display', ['block', 'inline', 'inline-block', 'none'], 'd');
  ...
  testClassNamesForProperty<any.FontWeight>('fontWeight', ['light', 'normal', 'bold'], 'font-weight');
