// AUTO-ADAPTED from cloudscape-design/components src/copy-to-clipboard/__tests__/
// copy-to-clipboard.test.tsx via tests/conformance/codemod.mjs.
...
import { act, render, waitFor } from '@conformance/adapter';

import CopyToClipboard from '@components/CopyToClipboard.pui';
