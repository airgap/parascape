// AUTO-ADAPTED from cloudscape-design/components src/live-region/__tests__/
// live-region.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, dropped named types from live-region/internal.js; interaction (manual-triage tier).
