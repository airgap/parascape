...
// render → adapter, styles → vendored, stubbed unresolvable ../../../lib/components/internal/hooks/use-mobile; stubbed unresolvable ../../../lib/components/property-filter; stubbed unresolvable ../../../lib/components/select; stubbed unresolvable ../../../lib/components/table/body-cell/styles.css.js; stubbed unresolvable ../../../lib/components/table/header-cell/styles.css.js; interaction (manual-triage tier).
...
import popoverStyles from '@cloudscape/popover.styles.js';
const bodyCellStyles = __STUB; // stub: ../../../lib/components/table/body-cell/styles.css.js
const headerCellStyles = __STUB; // stub: ../../../lib/components/table/header-cell/styles.css.js
import styles from '@cloudscape/table.styles.js';
...
const defaultColumns: any.ColumnDefinition<Item>[] = [
  { header: 'id', cell: item => item.id, isRowHeader: true },
  { header: 'name', cell: item => item.name },
];
const defaultColumnsWithIds: any.ColumnDefinition<Item>[] = [
  { id: 'id', header: 'id', cell: item => item.id },
  { id: 'name', header: 'name', cell: item => item.name },
];

const statefulColumns: any.ColumnDefinition<Item>[] = [
  {
    header: 'Counter 1',
...
test('should render table with react content', () => {
  const columns: any.ColumnDefinition<Item>[] = [
    ...defaultColumns,
    {
      header: (
        <>
...
test('track by can be a function', () => {
  const trackByFn: any.TrackBy<Item> = item => item.id + item.name;
  const { rerender, getByTestId, queryByTestId } = renderTable(
