// AUTO-ADAPTED from cloudscape-design/components src/key-value-pairs/__tests__/
// key-value-pairs.test.tsx via tests/conformance/codemod.mjs.
...
import KeyValuePairs from '@components/KeyValuePairs.pui';
import Link from '@components/Link.pui';
import SpaceBetween from '@components/SpaceBetween.pui';
import { createWrapper, IconWrapper } from '@conformance/adapter';
