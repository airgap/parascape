...
describe('Form Component', () => {
	describe('structure', () => {
		...
		it('form error includes alert and live region', () => {
			...
			expect(wrapper.findByClassName(alertStyles.root)!.getElement()).toHaveTextContent(
				'Some error',
			);
			expect(wrapper.findByClassName(liveRegionStyles.root)!.getElement()).toHaveTextContent(
				'Error icon, Some error',
			);
		});
