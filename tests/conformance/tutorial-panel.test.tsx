...
import TutorialPanel from '@components/TutorialPanel.pui';
import { getTutorials, i18nStrings } from '@conformance/tutorial-panel.data';
...
function renderTutorialPanel(props?: Partial<any>) {
