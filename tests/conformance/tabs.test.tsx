...
import Tabs from '@components/Tabs.pui';
import { createWrapper, TabsWrapper } from '@conformance/adapter';
...
const defaultTabs: Array<any.Tab> = [
  {
    id: 'first',
    label: 'First tab',
...
const actionDismissibleTabs: Array<any.Tab> = [
  {
    id: 'first',
    label: 'first tab',
    dismissible: true,
...
describe('Tabs', () => {
  ...
  describe('User interaction (controlled)', () => {
    ...
    describe.each(['automatic', 'manual'] as any['keyboardActivationMode'][])(
