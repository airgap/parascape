// AUTO-ADAPTED from cloudscape-design/components src/top-navigation/__tests__/
// top-navigation.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, i18n/testing → passthrough provider; jest.mock → hoisted vi.mock; stubbed unresolvable ../../../lib/components/top-navigation/parts/overflow-menu; interaction (manual-triage tier).
...
import { TopNavigationWrapper, OverflowMenu as OverflowMenuWrapper, } from '@conformance/adapter';
import TopNavigation from '@components/TopNavigation.pui';
const OverflowMenu = __STUB; // stub: ../../../lib/components/top-navigation/parts/overflow-menu
...
const I18N_STRINGS: any.I18nStrings = {
...
const renderTopNavigation = (props: PickPartial<any, 'i18nStrings'>) => {
