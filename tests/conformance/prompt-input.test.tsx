// AUTO-ADAPTED from cloudscape-design/components src/prompt-input/__tests__/
// prompt-input.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, jest.mock → hoisted vi.mock; stubbed unresolvable ../../internal/keycode; interaction (manual-triage tier).
...
import { act, render } from '@conformance/adapter'; // unsupported: within

import '../../__a11y__/to-validate-a11y';
import PromptInput from '@components/PromptInput.pui';
import { createWrapper } from '@conformance/adapter';
import { PromptInputWrapper } from '@conformance/adapter';
...
const renderPromptInput = (promptInputProps: any & React.RefAttributes<HTMLTextAreaElement>) => {
...
describe('prompt input in form', () => {
  function renderPromptInputInForm(props: any = { value: '', actionButtonIconName: 'send' }) {
