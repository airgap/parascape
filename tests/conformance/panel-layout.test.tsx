// AUTO-ADAPTED from cloudscape-design/components src/panel-layout/__tests__/
// panel-layout.test.tsx via tests/conformance/codemod.mjs.
// Mechanical rewrites only: component import → .pui, createWrapper +
// render → adapter, styles → vendored, jest.mock → hoisted vi.mock; stubbed unresolvable ../../../lib/components/app-layout/visual-refresh-toolbar/drawer/use-resize; stubbed unresolvable ../../../lib/components/internal/utils/use-container-width; interaction (manual-triage tier).
...
const { useResize } = __STUB; // stub: ../../../lib/components/app-layout/visual-refresh-toolbar/drawer/use-resize
const useContainerWidth = __STUB; // stub: ../../../lib/components/internal/utils/use-container-width
import PanelLayout from '@components/PanelLayout.pui';
import { createWrapper } from '@conformance/adapter';

// Mock the useContainerWidth hook
vi.mock('../../../lib/components/internal/utils/use-container-width', async (importOriginal) => ({
  __esModule: true,
  default: jest.fn(),
}));

// Mock the useResize hook
vi.mock('../../../lib/components/app-layout/visual-refresh-toolbar/drawer/use-resize', async (importOriginal) => ({
  useResize: jest.fn(),
}));

function renderPanelLayout(props: Partial<any> = {}) {
